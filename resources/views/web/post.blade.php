...
<div class="page-banner blog-post-banner container-fluid no-padding">
    <!-- Container -->
    <div class="container">
        <h3>{{$data['dataPages'][0]->post_judul}}</h3>
            ...
            <div class="col-md-9 col-sm-8 col-xs-12 blog-area">
                <article class="blog-post-list single-post col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="entry-content" style="color:#fff !important">
                        ...
                        <div class="post-meta">
                            <a href="#" title="{{$data['dataPages'][0]->post_tanggal }}" class="post-date">
                                {{$data['dataPages'][0]->post_tanggal }}</a> by
                            <a href="#" title="Mathov" class="post-admin">{{$data['dataPages'][0]->post_oleh }}</a>
                        </div>
                        <div class="content">
                            {{!! $data['dataPages'][0]->post_konten !!}}
                        </div>
                    </div>
                </article>
                <!-- About Author -->
