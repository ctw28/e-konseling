                ...
                <div class="item active">
                    ...
                    <div class="col-md-6 col-sm-6 no-padding">
                        <div class="banner-right">
                            <img src="{{ asset('template-web')}}/images/banner-main.png" alt="banner-main" />
                        </div>
                    </div>
                </div>
                <div class="item">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 emargency-case">
                <div class="col-md-6 message-block no-left-padding">
                    <h3>Layanan Assemen</h3>
                    <p>Layanan Assesmen berupa layanan yang bertujuan untuk mengungkap jati dirimu</p>
                    <a href="#">Lebih Lanjut<i class="fa fa-caret-right"></i></a>
                </div>
                <div class="col-md-6 message-block no-right-padding">
                    <h3>Layanan Konseling</h3>
                    <p>Dignissimos ducimus qui blanditii sentium volta tum deleniti atque cori as quos dolores
                        et quas mole.</p>
            ...
            <div class="col-md-6 col-sm-6 opening-hours">
                <div class="col-md-6 message-block no-padding">
                    <h3>Jam Pelayanan</h3>
                    <ul>
                        <li>Senin - Jumat<span class="pull-right">8.00 – 16.30</span></li>
                        <li>Istirahat<span class="pull-right">12.00-13.00</span></li>
                    </ul>
                </div>
                <div class="col-md-6 message-block">
                    <h3>Konselor </h3>
                    <p>Konselor akan memberikan pelayanan semaksimal mungkin untuk mendapatkan solusi dari permasalahan.
                    </p>
                    <a href="#">More Details<i class="fa fa-caret-right"></i></a>
                </div>
            </div><!-- Opening Hours /- -->
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12 col-xs-12 service">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="service-block">
                            <div class="service-block-icon">
                                <i><img src="{{ asset('template-web/')}}/images/ambulance.png" alt="ambulance" /></i>
                                <i><img src="{{ asset('template-web/')}}/images/ambulance-white.png"
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="service-block">
                            <div class="service-block-icon">
                                <i><img src="{{ asset('template-web/')}}/images/heart-ic.png" alt="heart-ic" /></i>
                                <i><img src="{{ asset('template-web/')}}/images/heart-ic-white.png"
                                        alt="heart-ic-white" /></i>
                            </div>
                            <div class="service-block-content">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="service-block">
                            <div class="service-block-icon">
                                <i><img src="{{ asset('template-web')}}/images/phone.png" alt="phone" /></i>
                                <i><img src="{{ asset('template-web')}}/images/phone-white.png" alt="phone-white" /></i>
                            </div>
                            <div class="service-block-content">
                                <h3>24/7 support</h3>
                                <p>Dolor sit amet consecdi pisicing eliam sed do eiusmod tempornu.</p>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="service-block">
                            <div class="service-block-icon">
                                <i><img src="{{ asset('template-web')}}/images/appoinment-latter.png"
                                        alt="appoinment-latter" /></i>
                                <i><img src="{{ asset('template-web')}}/images/appoinment-latter-white.png"
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <form class="appoinment-form">
                    <h3><img src="{{ asset('template-web/')}}/images/appoinment.png" alt="appoinment" />Appointment form
                    </h3>
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 no-padding">
                        ...
                        <button type="submit" id="btn_submit" class="btn-submit pull-right">
                            <img src="{{ asset('template-web/')}}/images/heart-sm.png" alt="heart-sm">Submit</button>
                    </div>
...
<div id="what-we-do-best" class="container-fluid no-padding what-we-do-best">
    ...
    <div class="what-we-do-left col-md-4 no-padding">
        <img src="{{ asset('template-web/')}}/images/what-we-do-best.jpg" alt="what-we-do-best">
    ...
    <div class="col-md-8 what-we-do-right no-padding">
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/pulmonary.png" alt="pulmonary" /></i>
                    <h5>Pulmonary</h5>
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/cardiology.png" alt="Cardiology" /></i>
                    <h5>Cardiology</h5>
                    <p>Nam libero tempore cumas soluta eligendi </p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/traumatology.png" alt="Traumatology" /></i>
                    <h5>Traumatology</h5>
                    <p>Nam libero tempore cumas soluta eligendi </p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/neurology.png" alt="Neurology" /></i>
                    <h5>Neurology</h5>
                    <p>Nam libero tempore cumas soluta eligendi </p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding what-we-do-title">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-title-bg.jpg"
                    alt="what-we-do-best-title" />
                <div class="what-we-do-block-content">
                    <h3>What we do best</h3>
                    <p>Dolor sit amet consecdi pisicing eliam sedo</p>
                    <span><img src="{{ asset('template-web/')}}/images/section-seprator.png"
                            alt="section-seprator" /></span>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/x-ray.png" alt="X-ray" /></i>
                    <h5>X-ray</h5>
                    <p>Nam libero tempore cumas soluta eligendi </p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/nuclear-magnetic.png" alt="Nuclear magnetic" /></i>
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/diagnostic.png" alt="Diagnostic" /></i>
                    <h5>Diagnostic</h5>
                    <p>Nam libero tempore cumas soluta eligendi </p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
            <div class="what-we-do-block">
                <img src="{{ asset('template-web/')}}/images/what-we-do-best-block-bg.jpg" alt="what-we-do-best" />
                <div class="what-we-do-block-content">
                    <i><img src="{{ asset('template-web/')}}/images/blood-test.png" alt="Blood test" /></i>
                    <h5>Blood test</h5>
                    <p>Nam libero tempore cumas soluta eligendi </p>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="team-carousel">
            <div class="col-md-12 team-type">
                <img src="{{ asset('template-web/')}}/images/doctor-1.jpg" alt="doctor-1" />
                <div class="member-content">
                    ...
                    <div class="member-contact">
                        <a title="Phone" href="#"><img src="{{asset('template-web/')}}/images/ftr-phone.png"
                                alt="Phone" /></a>
                        <a title="Mail" href="#"><img src="{{asset('template-web/')}}/images/ftr-email.png"
                                alt="Email" /></a>
                    </div>
                </div>
            </div>
            <div class="col-md-12 team-type">
                <img src="{{ asset('template-web/')}}/images/doctor-2.jpg" alt="doctor-2" />
                <div class="member-content">
                    <div class="member-name">
                        <h6>Dr.Adaline Becka</h6>
                        <p>Dental Specialist</p>
            ...
            <div class="col-md-12 team-type">
                <img src="{{ asset('template-web/')}}/images/doctor-3.jpg" alt="doctor-3" />
                <div class="member-content">
                    <div class="member-name">
                        <h6>Dr.Adaline Becka</h6>
                        <p>Dental Specialist</p>
...
<div class="container-fluid no-padding department-section">
    <div class="we-are-best col-md-6 col-sm-12 no-padding">
        <div class="section-header">
            ...
            <p>Accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum delaut eniti
                atque corrupti quos dolores et quas.</p>
        </div>
        <div class="we-are-best-block">
            <div class="we-are-best-icon">
                <img src="{{ asset('template-web/')}}/images/dp-icon-1.png" alt="dp-icon-1" />
            </div>
            <div class="we-are-best-content">
                <h3>Free Medical Counseling</h3>
                <p>Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores euas molestias
                    excepturi sint occaecati cupiditate.</p>
            </div>
        </div>
        <div class="we-are-best-block">
            <div class="we-are-best-icon">
                <img src="{{ asset('template-web/')}}/images/dp-icon-2.png" alt="dp-icon-2" />
            </div>
            <div class="we-are-best-content">
        ...
        <div class="we-are-best-block">
            <div class="we-are-best-icon">
                <img src="{{ asset('template-web/')}}/images/dp-icon-3.png" alt="dp-icon-3" />
            </div>
            <div class="we-are-best-content">
    ...
    <div class="col-md-6 col-sm-12 departments no-padding">
        <div class="departments-bg">
            <img src="{{ asset('template-web/')}}/images/departments-bg.jpg" alt="departments-bg" />
        </div>
        <div class="section-header">
        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
                ...
                <div id="dept-type-1" class="panel-collapse collapse in" role="tabpanel"
                    ...
                    <div class="panel-img">
                        <img src="{{ asset('template-web/')}}/images/panel-img-1.jpg" alt="panel-img" />
                    </div>
        ...
        <div class="col-md-6 col-sm-6 no-padding">
            ...
            <div class="counter-app">
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="statistics-box">
                        <i class="statistics-icon"><img alt="statistics-icon"
                                src="{{asset('template-web')}}/images/icon-1.png"></i>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="statistics-box">
                        <i class="statistics-icon"><img alt="statistics-icon"
                                src="{{asset('template-web')}}/images/icon-2.png"></i>
                        <div class="statistics-content">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="statistics-box">
                        <i class="statistics-icon"><img alt="statistics-icon"
                                src="{{asset('template-web')}}/images/icon-3.png"></i>
                        <div class="statistics-content">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="statistics-box">
                        <i class="statistics-icon"><img alt="statistics-icon"
                                src="{{asset('template-web')}}/images/icon-4.png"></i>
                        <div class="statistics-content">
    ...
    <div class="container">
        ...
        <div class="row">
            <article class="col-md-6 col-sm-12 col-xs-12">
                <div class="entry-header">
                    <div class="entry-cover">
                        <a href="blog-post.html"><img src="{{ asset('template-web/')}}/images/latest-news-1.jpg"
                                alt="latest-news" /></a>
            ...
            <article class="col-md-6 col-sm-12 col-xs-12">
                <div class="entry-header">
                    <div class="entry-cover">
                        <a href="blog-post.html"><img src="{{ asset('template-web/')}}/images/latest-news-2.jpg"
                                alt="latest-news" /></a>
                        <a href="blog-post.html" class="read-more"><i class="fa fa-link"></i>Read More</a>
                    </div>
                </div>
